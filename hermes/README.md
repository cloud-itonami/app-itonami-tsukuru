...
| profile | description |
|---|---|
| `tsukuru-design-review` | tsukuru 運営 fleet: 商品設計 sim/審査/RFQ 進行 |
| `tsukuru-rfq` | tsukuru 運営 fleet: 商品設計 sim/審査/RFQ 進行 |
| `tsukuru-sim` | tsukuru 運営 fleet: 商品設計 sim/審査/RFQ 進行 |
